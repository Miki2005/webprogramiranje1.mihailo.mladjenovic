...
ime.innerHTML=`<input type="text" name="ime" id="ime1" placeholder="Ime:Primer(Mihailo)" /><span class="span-forma">Ime mora početi velikim
 slovom</span>`;
document.getElementById("prezime").innerHTML=`<input type="text" name="prezime" id="prezime1" placeholder="Prezime:Primer(Mlađenović)" />
<span class="span-forma2">Prezime mora početi velikim slovom</span>`;
email1.innerHTML=`<input type="text" name="email" id="email7" placeholder="Email:Primer(mihailo.mladjenovic@gmail.com)" />
...
function dodaj(){
    ime2.innerHTML=`<input type="text" name="ime" id="ime3" placeholder="Ime:Primer(Mihailo)" /><span class="span-forma">
    Ime mora početi velikim slovom</span>`;
    prezime2.innerHTML=`<input type="text" name="prezime" id="prezime" placeholder="Prezime:Primer(Mlađenović)" />
    <span class="span-forma2">Prezime mora početi velikim slovom</span>`;
    email2.innerHTML=`<input type="text" name="email" id="email" placeholder="Email:Primer(mihailo.mladjenovic@gmail.com)" />
...
function ispisDrustveneMreze(){
    ...
    let radno=["Zdravka Čelara 16,Beograd","mihailo.mladjenovic.23.23@ict.edu.rs"];
